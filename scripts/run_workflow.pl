...
run("rm /data/datastore/normal/normal.bam; ln -s $normal_bam /data/datastore/normal/normal.bam");
run("samtools index /data/datastore/normal/normal.bam");
run("rm /data/datastore/tumor/tumor.bam; ln -s $tumor_bam /data/datastore/tumor/tumor.bam");
run("samtools index /data/datastore/tumor/tumor.bam");
run("rm /data/datastore/delly/delly.bedpe.txt; ln -s $bedpe /data/datastore/delly/delly.bedpe.txt");
...
run("mkdir -p /mnt/datastore/ && sudo rm /mnt/datastore/bundledFiles; ln -s \$TMPDIR/reference/bundledFiles /mnt/datastore/");
